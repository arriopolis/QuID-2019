...
if __name__ == "__main__":
    # points = generate_points(32)
    points = points_from_file('img/batman.txt')
    ...
    first_fcs = None
    for cc,qft,fst in [(False,False,False),(False,True,False),(False,True,True),(True,True,False),(True,True,True)]:
